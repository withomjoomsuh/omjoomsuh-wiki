...
The three vertical bands map to the three bodies of yogic anatomy:
**Karana sharira** (the causal body) — where the eshanas live
**Sukshma sharira** (the subtle body) — where the instincts express, where vasana sits, where kamna arises
**Sthula sharira** (the gross body) — where the desire is acted out, and where its consequence (dharma or adharma) is reaped
...
6. **Loss of [[Buddhi|buddhi]]** — the destruction of discriminating intelligence
...
**One — interrupt the cascade earlier.** [[Sadhana|Daily practice]] — [[Pranayama|pranayama]], mantra, [[Yoga Nidra|yoga nidra]], silence — builds the capacity to observe a thought *before* it has hardened into attachment, and an attachment *before* it has hardened into named kamna. This is the contemporary research on mindfulness translating directly into the Gita's prescription. The cascade can be interrupted at any point; the earlier the better.

**Two — calm the underlying nervous system.** The chronic stress load that elevates [[Cortisol Awakening Response|cortisol]] also pushes the dopamine system into the deficit state Lembke describes. Practices that tone the [[Vagus Nerve|vagus nerve]] — slow breath, mantra recitation, [[Pratyahara|pratyahara]] — lower the baseline arousal and reduce the desperate quality of kamna. A calm body is a body that wants less.
